 ...
 * This Revision: $Id: usbconfig.h 310 2007-03-29 17:14:30Z cs $
 */
...
#ifndef USE_SHARED_PID
#define USB_CFG_VENDOR_ID       0xc0, 0x16
/* USB vendor ID for the device, low byte first. 0x16c0 is voti.nl's vendor
 * ID. Use only Product- and Vendor-IDs you have licensed if the product ever
 * leaves your desk!
 */
#define USB_CFG_DEVICE_ID       0xeb, 0x03  /* = 1003 = reserved for lab tests */
 ...
 * share the same product and vendor IDs. Even if the devices are never on the
 * same bus together!
 */
#endif
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'R', 'e', 'm', 'o', 't', 'e', ' ', 'S', 'e', 'n', 's', 'o', 'r'
